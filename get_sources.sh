...
# DEPENDENCIES_Centos_Fedora: fontconfig-devel freetype-devel bzip2-devel rubberband-devel fftw3-devel libsamplerate-devel gmp-devel expat-devel libpng-devel
...
git_get_fresh  nasm                       https://repo.or.cz/nasm.git &
